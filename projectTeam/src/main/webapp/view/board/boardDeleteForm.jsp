...
<div class="cols-content" id="menu">
   ...
   <div class="wrap-login" style="display: flex;">
    <div class="sect-login" style="margin:auto; ">
        
        <div class="box-login">
            <h3 class="hidden">게시글 삭제</h3>
            <form action="boardDeletePro?boardnum=${boardnum}" method="post" >
            <fieldset>
                <div class="password">
                <p>비밀번호</p>
                    <input type="password" id="pass" name="pass" required="required" style="width:248px;">
                </div>
                <button type="submit" id="submit" title="비밀번호"><span>삭제</span></button>
