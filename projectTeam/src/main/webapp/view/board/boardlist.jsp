    ...
    <div class="col-aside">
      <div class="skipnaiv">
       ...
       <div class="snb">
           <ul>
               <li class="on">
                    <a href="#" title="현재 선택">MY KIC HOME <i></i></a>
                </li>
               <li>
                    <a href="">회원정보<i></i></a>
                   <ul>
               ...
               <li>
                    <a href="${pageContext.request.contextPath}/board/boardlist">나의 문의내역 <i></i></a>
                   <ul>
                       <li>
                            <a href="#">1:1 문의</a>
                        </li>
            ...
            <tbody id="items">
                ...
                <tr>
                    <td colspan="7" class="nodata">
					   ...
					   <td><a href="${pageContext.request.contextPath}/board/boardInfo?boardnum=${m.boardnum}">${m.subject }</a></td>
					   <td>${m.formattedRegdate }</td>
					   <td>
					   
						    <c:if test="${m.replycomment ne null}">
						        답변 등록
						        
						    </c:if>
						    <c:if test="${m.replycomment eq null}">
						        답변 미등록
						    </c:if>
					   </td>
    ...
    <div class="sect-mycgv-reserve qna">
        <div class="box-polaroid">
           <div class="box-inner qna">
               <p><strong>자주하시는 질문</strong> <a href="#" class="round gray on"><span>바로가기</span></a></p>
               <span>고객님들께서 주로 하시는 질문에 대한 답변을<br>한곳에 모아두었습니다.</span>
           </div>
           <div class="box-inner words">
               <p><strong>고객의 말씀</strong> <a href="${pageContext.request.contextPath}/board/writing" class="round gray on"><span>문의하기</span></a></p>
