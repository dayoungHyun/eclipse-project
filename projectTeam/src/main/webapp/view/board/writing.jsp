...
<div class="cols-content" id="menu">
   ...
   <div class="col-detail" id="mycgv_contents">
    ...
    <p class="stit">불편사항이나 문의사항을 남겨주시면 최대한 신속하게 답변 드리겠습니다.</p><br>
        <form action="writingPro" id="form1" name="form1" method="post" novalidate="novalidate"   enctype="multipart/form-data">
            <fieldset>
                        ...
                        <tbody>                           
                            <tr >
                                ...
                                <td colspan="3" style="border-top: none;">
                                    <input type="text" id="inp_title" name="subject" class="inp01" style="width: 672px;">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="3">
                                    <textarea cols="60" rows="5" id="inp_textbox" name="content" class="inp_txtbox01" style=" height:94px !important;" onkeyup="javascript:checkByte(this,5000,'sp_ad_content_size_1', 'sp_ad_content_size_2');" 
                                    ></textarea>
                                </td>
                            </tr>
                ...
                <div class="box-btn qna_email" id="resetsubmit">
                    <button style="margin-right:20px " type="reset" class="round gray"><span style="padding:0 14px;">취소</span></a>
                    <button style="width:80px" class="round inred" type="submit" ><span>등록하기</span></button>
                </div>
            </fieldset>
        </form>
