                    ...
                    <table cellspacing="0" cellpadding="0" class="tbl_notice_list tbl_left">
                        ...
                        <tbody>                           
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <textarea cols="60" rows="5" id="inp_textbox" name="inp_textbox" class="inp_txtbox01" style=" height:94px !important;" onkeyup="javascript:checkByte(this,5000,'sp_ad_content_size_1', 'sp_ad_content_size_2');" ></textarea>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3" style="text-align: left;">
                                     <input style="width:300px; margin-bottom:10px;" type="file" id="voc_upload_file" name="voc_upload_file" title="voc파일 업로드" size="51" onclick="javascript:alert('주민번호 등 개인정보가 포함된 파일이 첨부되지 않도록 유의하시기 바랍니다.');"> 
