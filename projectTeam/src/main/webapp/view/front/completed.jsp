...
<div id="booking-details">
        <h2>예매 완료</h2>
        <p><strong>영화: ${mem.moviename }</strong> <span id="selected-movie"></span></p>
        <p><strong>상영관: ${mem.theatername }</strong> <span id="selected-location"></span></p>
        <p><strong>시간: ${mem.date2name } ${mem.timename }</strong> <span id="selected-time"></span></p>
        <p><strong>인원: ${mem.totalperson }명</strong> <span id="selected-people"></span></p>
    </div>
