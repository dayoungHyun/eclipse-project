...
document.addEventListener('DOMContentLoaded', function() {
    ...
    items.forEach((item) => {
        item.addEventListener('mouseover', function() {
            ...
            // 현재 항목을 마지막으로 마우스가 올라간 항목으로 설정
            lastHoveredItem = item;
        });
    });

    // 마우스가 리스트 항목을 떠나면 마지막으로 올라간 항목의 이미지로 변경
    items.forEach((item) => {
        item.addEventListener('mouseout', function() {
            if (lastHoveredItem !== null) {
                switch (lastHoveredItem.firstElementChild.className) {
                    case 'a':
                        imgElement.src = 'https://img.cgv.co.kr//Front/Main/2021/1209/16390080561620.png';
                        break;
                    case 'b':
...
<div id="contaniner" class="">
    ...
    <div id="contents" class="">
        ...
        <div class="movie-list">
            <h2 class="list-text">현재 상영중인 영화</h2>
            <ul class="movie-class">
                <li class="movie-content">
        <a href="${pageContext.request.contextPath}/detailpage/detail01" class="movie-link">
            <img src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88266/88266_320.jpg" alt="">
            <h3>원더랜드</h3>
        </a>
        <div class="btn-group">
            <a href="${pageContext.request.contextPath}/detailpage/detail01" class="btn_detail">상세보기&emsp;&emsp;&emsp;&emsp;</a>
            <a href="${pageContext.request.contextPath}/front/reservation" class="btn_ticketing">&emsp;&emsp;&emsp;&emsp;예매하기</a>
        </div>
    </li>
    <li class="movie-content">
        <a href="${pageContext.request.contextPath}/detailpage/detail02" class="movie-link">
            <img src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88214/88214_320.jpg" alt="">
            <h3>극장판 하이큐!! 쓰레기장의 결전</h3>
        </a>
        <div class="btn-group">
            <a href="${pageContext.request.contextPath}/detailpage/detail02" class="btn_detail">상세보기&emsp;&emsp;&emsp;&emsp;</a>
            <a href="${pageContext.request.contextPath}/front/reservation" class="btn_ticketing">&emsp;&emsp;&emsp;&emsp;예매하기</a>
        </div>
    </li>
    <li class="movie-content">
        <a href="${pageContext.request.contextPath}/detailpage/detail03" class="movie-link">
            <img src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88148/88148_320.jpg" alt="">
            <h3>퓨리오사 - 매드맥스</h3>
        </a>
        <div class="btn-group">
            <a href="${pageContext.request.contextPath}/detailpage/detail03" class="btn_detail">상세보기&emsp;&emsp;&emsp;&emsp;</a>
            <a href="${pageContext.request.contextPath}/front/reservation" class="btn_ticketing">&emsp;&emsp;&emsp;&emsp;예매하기</a>
        </div>
    </li>
    <li class="movie-content">
        <a href="${pageContext.request.contextPath}/detailpage/detail06" class="movie-link">
            <img src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88220/88220_320.jpg" alt="">
            <h3>설계자</h3>
        </a>
        <div class="btn-group">
            <a href="${pageContext.request.contextPath}/detailpage/detail06" class="btn_detail">상세보기&emsp;&emsp;&emsp;&emsp;</a>
            <a href="${pageContext.request.contextPath}/front/reservation" class="btn_ticketing">&emsp;&emsp;&emsp;&emsp;예매하기</a>
        </div>
    </li>
                <!-- 더 많은 영화 항목 추가 가능 -->
        ...
        <div><!-- Event Area -->
            <h2 class="list-text"> EVENT </h2>
            <ul class="event-list">
                <li>
                    <img class="event-pic" src="https://img.cgv.co.kr/WebApp/contents/eventV4/40677/17170443630970.jpg">
                    <h3 class="pic-head">신규 회원들 주목</h3>
                    <p class="pic-content">2024.05.30 ~ 2024.07.01</p>
                </li>
                <li>
                    <img class="event-pic" src="https://img.cgv.co.kr/WebApp/contents/eventV4/40683/17173770078870.jpg">
                    <h3 class="pic-head">[나쁜녀석들]SX포스터</h3>
                    <p class="pic-content">2024.05.29 ~ 2024.06.12</p>
                </li>
                <li>
                    <img class="event-pic" src="https://img.cgv.co.kr/WebApp/contents/eventV4/40684/17173763633560.jpg">
                    <h3 class="pic-head">[나쁜녀석들] 4DX포스터</h3>
                    <p class="pic-content">2024.05.29 ~ 2024.06.12</p>
                </li>
            </ul>
        </div> <!-- Event Area -->
        <div><!-- special Area -->
            <h2 class="list-text"> 특별관 </h2>
            <div class="special-head">
                <img class="special-pic" src="https://img.cgv.co.kr//Front/Main/2021/1209/16390080561620.png">
                
                    <ul class="special-content">
                        <li><a href="#" class="a">suite cinema</a></li>
                        <li><a href="#" class="b">cine & livingroom</a></li>
                        <li><a href="#" class="c">4dx</a></li>
                        <li><a href="#" class="d">cine de chef</a></li>
                    </ul>
