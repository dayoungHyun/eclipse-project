...
<div class="sect-base-movie">
    <h3><strong>존 오브 인터레스트</strong>기본정보</h3>
    <div class="box-image">
        <a href="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88270/88270_320.jpg" title="포스터 크게 보기 새창" target="_blank">
            <span class="thumb-image"> 
                <img src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88270/88270_320.jpg" alt="인사이드 아웃 2 포스터 새창" onerror="errorImage(this)">
    ...
    <div class="box-contents">
        <div class="title"> 
            <span class="age-12">12</span><strong>존 오브 인터레스트</strong>
        ...
        <div class="score"> 
            <strong class="percent">예매율&nbsp;<span>3.8%</span></strong>
        ...
        <div class="spec">
            <dl>
                ...
                <dd>
                        ...
                        <a href="/movies/persons/?pidx=124244">조나단 글레이저</a>                    
                ...
                <dd class="on">
                        ...
                        <a href="/movies/persons/?pidx=33445">크리스티안 프리에델</a>                    
                        
                        ,&nbsp;
                        <a href="/movies/persons/?pidx=123816">산드라 휠러</a>
                </dd>
                ...
                <dd class="on">12세이상관람가,&nbsp;105분,&nbsp;미국</dd>
                <dt>개봉 :&nbsp;</dt>
    ...
    <div class="cols-content" id="menu">
        <div class="col-detail">
            ...
            <div class="sect-story-movie">
                독일 장교 루돌프 회스(크리스티안 프리델)의 가족이 사는<br>
				그들만의 꿈의 왕국 아우슈비츠.<br>
				아내 헤트비히(산드라 휠러)가 정성스럽게 가꾼 꽃이 만발한 정원에는<br>
