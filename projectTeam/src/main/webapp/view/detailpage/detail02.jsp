...
<div class="sect-base-movie">
    ...
    <div class="box-image">
        <a href="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88214/88214_320.jpg" title="포스터 크게 보기 새창" target="_blank">
            <span class="thumb-image"> 
                <img src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88214/88214_320.jpg" alt="인사이드 아웃 2 포스터 새창" onerror="errorImage(this)">
    ...
    <div class="box-contents">
        <div class="title"> 
            <span class="age-all">ALL</span><strong>극장판 하이큐!! 쓰레기장의 결전</strong>
        ...
        <div class="score"> 
            <strong class="percent">예매율&nbsp;<span>14.8%</span></strong>
        ...
        <div class="spec">
            <dl>
                ...
                <dd>
                        ...
                        <a href="/movies/persons/?pidx=124244">미츠나카 스스무</a>                    
    ...
    <div class="cols-content" id="menu">
        <div class="col-detail">
            ...
            <div class="sect-story-movie">
                봄철 고교 배구대회 1회전과 2회전에서<br>
				우승 후보를 차례로 꺾은 카라스노 고등학교는<br>
				마침내 3회전에서<br>
				인연의 라이벌 네코마 고등학교와 맞붙게 된다.<br><br>
				 
				공식 경기에서 처음으로 대결하는 두 고등학교,<br>
				통칭 까마귀 VS 고양이 ‘쓰레기장의 결전’.<br>
