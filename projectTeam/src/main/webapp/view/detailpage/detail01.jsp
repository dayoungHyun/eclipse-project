...
<div class="sect-base-movie">
    <h3><strong>원더랜드</strong>기본정보</h3>
    <div class="box-image">
        <a href="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88266/88266_320.jpg" title="포스터 크게 보기 새창" target="_blank">
            <span class="thumb-image"> 
                <img src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88266/88266_320.jpg" alt="인사이드 아웃 2 포스터 새창" onerror="errorImage(this)">
    ...
    <div class="box-contents">
        <div class="title"> 
            <span class="age-12">12</span><strong>원더랜드</strong>
        ...
        <div class="score"> 
            <strong class="percent">예매율&nbsp;<span>24.5%</span></strong>
        ...
        <div class="spec">
            <dl>
                ...
                <dd>
                        ...
                        <a href="/movies/persons/?pidx=124244">김태용</a>                    
                ...
                <dd class="on">
                        ...
                        <a href="/movies/persons/?pidx=33445">탕웨이</a>                    
                        
                        ,&nbsp;
                        <a href="/movies/persons/?pidx=123816">배수지</a>                    
                        
                        ,&nbsp;
                        <a href="/movies/persons/?pidx=17244">박보검</a>                    
                        
                        ,&nbsp;
                        <a href="/movies/persons/?pidx=124563">정유미</a>                    
                        
                        ,&nbsp;
                        <a href="/movies/persons/?pidx=30693">최우식</a>                    
                ...
                <dd class="on">12세이상관람가,&nbsp;113분,&nbsp;한국</dd>
                <dt>개봉 :&nbsp;</dt>
                <dd class="on">2024.06.05</dd>
        ...
        <span class="like">
            <a class="link-reservation" href="${pageContext.request.contextPath}/front/reservation">예매</a> 
    ...
    <div class="cols-content" id="menu">
        <div class="col-detail">
            ...
            <div class="sect-story-movie">
                <strong>언제 어디서든 다시 만날 수 있습니다</strong><br>
				<br>
				죽은 사람을 인공지능으로 복원하는<br>
				‘원더랜드’ 서비스가 일상이 된 세상,<br>
				어린 딸에게 자신의 죽음을 숨기기 위해<br>
				‘원더랜드’ 서비스를 의뢰한 ‘바이리’와<br>
				사고로 누워있는 남자친구 ‘태주’를 ‘원더랜드’에서<br>
				우주인으로 복원해 행복한 일상을 나누는 ‘정인’.<br>
				사람들은 더 이상<br>
				그리워하거나 슬퍼하지 않는 삶을 선택할 수 있게 된다.<br><br>
				
				‘원더랜드’의 수석 플래너 ‘해리’와 신입 플래너 ‘현수’는<br>
				‘원더랜드’를 찾는 사람들이 소중한 기억을<br>
				이어갈 수 있도록 바쁜 하루하루를 보낸다.<br>
				어린 시절부터 인공지능 부모님과 교감해온 ‘해리’는<br>
				이용자들의 상황을 더욱 세심히 살피고,<br>
				‘현수’는 의뢰받은 서비스에서<br>
				뜻밖의 비밀을 발견하게 되어 마음이 쓰인다.<br><br>
				
				어느 날 의식불명 상태의 ‘태주’가<br>
				기적처럼 깨어나 ‘정인’ 곁으로 돌아오고<br>
				다시 마주하게 된 모든 것이 낯설고<br>
				혼란스러운 ‘태주’와<br>
				그런 그와 함께하는 현실에<br>
				‘정인’의 마음에는 조금씩 균열이 찾아온다.<br><br>
				
				한편, ‘원더랜드’에서 발굴 현장을 누비는<br>
				고고학자로 복원된 ‘바이리’는<br>
				딸과의 영상통화를 통해<br>
				친구 같은 엄마가 되기 위해 노력하지만<br>
				갑작스럽게 서비스가 종료되면서<br>
				예상치 못한 오류가 발생하는데…
			</div>
