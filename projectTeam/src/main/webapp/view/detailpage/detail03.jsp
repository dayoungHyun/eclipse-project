...
<div class="sect-base-movie">
    <h3><strong>퓨리오사-매드맥스 사가</strong>기본정보</h3>
    <div class="box-image">
        <a href="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88148/88148_320.jpg" title="포스터 크게 보기 새창" target="_blank">
            <span class="thumb-image"> 
                <img src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88148/88148_320.jpg" alt="인사이드 아웃 2 포스터 새창" onerror="errorImage(this)">
    ...
    <div class="box-contents">
        <div class="title"> 
            <span class="age-15">15</span><strong>퓨리오사-매드맥스 사가</strong>
        ...
        <div class="score"> 
            <strong class="percent">예매율&nbsp;<span>13.5%</span></strong>
        ...
        <div class="spec">
            <dl>
                ...
                <dd>
                        ...
                        <a href="/movies/persons/?pidx=124244">조지 밀러</a>                    
                ...
                <dd class="on">
                        ...
                        <a href="/movies/persons/?pidx=33445">얀야 테일러 조이</a>                    
                        
                        ,&nbsp;
                        <a href="/movies/persons/?pidx=123816">크리스 햄스워스</a>                    
                        
                        ,&nbsp;
                        <a href="/movies/persons/?pidx=17244">톰 버크</a>                                       
                ...
                <dd class="on">15세이상관람가,&nbsp;148분,&nbsp;미국</dd>
                <dt>개봉 :&nbsp;</dt>
    ...
    <div class="cols-content" id="menu">
        <div class="col-detail">
            ...
            <div class="sect-story-movie">
                문명 붕괴 45년 후,<br>
				황폐해진 세상 속 누구에게도 알려지지 않은<br>
				풍요가 가득한 ‘녹색의 땅’에서 자란 ‘퓨리오사’(안야 테일러-조이)는<br>
				바이커 군단의 폭군 ‘디멘투스’(크리스 헴스워스)의 손에 모든 것을 잃고 만다.<br><br>
				
				가족도 행복도 모두 빼앗기고 세상에 홀로 내던져진 ‘퓨리오사’는<br>
				반드시 고향으로 돌아가겠다는 어머니와의 약속을 지키기 위해<br>
				인생 전부를 건 복수를 시작하는데...<br><br>
				
				<strong>‘매드맥스’ 시리즈의 전설적인 사령관 ‘퓨리오사’의 대서사시<br>
				5월 22일, 마침내 분노가 깨어난다!</strong>
			</div>
