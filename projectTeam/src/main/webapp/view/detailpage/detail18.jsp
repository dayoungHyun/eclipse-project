...
<div class="sect-base-movie">
    <h3><strong>키타로 탄생 게게게의 수수께끼 </strong>기본정보</h3>
    <div class="box-image">
        <a href="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88265/88265_320.jpg" title="포스터 크게 보기 새창" target="_blank">
            <span class="thumb-image"> 
                <img src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88265/88265_320.jpg" alt="인사이드 아웃 2 포스터 새창" onerror="errorImage(this)">
    ...
    <div class="box-contents">
        <div class="title"> 
            <span class="age-15">15</span><strong>키타로 탄생 게게게의 수수께끼 </strong>
            <em class="round lightblue"><span>현재상영중</span></em>
            
            
            <p>The Birth of Kitaro: The Mystery of GeGeGe</p>
        </div>
        <div class="score"> 
        ...
        <div class="spec">
            <dl>
                ...
                <dd>
                        ...
                        <a href="/movies/persons/?pidx=124244">코가 고</a>                    
                ...
                <dd class="on">15세이상관람가,&nbsp;105분,&nbsp;일본</dd>
                <dt>개봉 :&nbsp;</dt>
    ...
    <div class="cols-content" id="menu">
        <div class="col-detail">
            ...
            <div class="sect-story-movie">
                <strong>“절대 엿봐서는 안되는 금지된 이야기”</strong><br><br>
 
				폐허가 된 나구라 마을,<br>
				키타로와 눈알 아버지는<br>
				70년 전 이곳에서 일어났던 사건을 떠올린다<br><br>
				 
				류가 가문의 당주 '토키사다'의 장례식 참석을 명목으로<br>
				수수께끼를 쫓아 마을로 오게 된 ‘미즈키’<br>
				한편 실종된 아내를 찾기 위해<br>
				마을에 도착한 키타로의 아버지<br>
				‘토키사다’의 후계자 자리를 두고 소란스러운 가운데<br>
				가문의 일족들이 하나둘씩 살해를 당하는데...<br><br>
				 
				인간과 요괴, 두 남자의 운명적인 만남 속<br>
