...
<div class="sect-base-movie">
    <h3><strong>설계자</strong>기본정보</h3>
    <div class="box-image">
        <a href="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88220/88220_320.jpg" title="포스터 크게 보기 새창" target="_blank">
            <span class="thumb-image"> 
                <img src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88220/88220_320.jpg" alt="인사이드 아웃 2 포스터 새창" onerror="errorImage(this)">
    ...
    <div class="box-contents">
        <div class="title"> 
            <span class="age-15">15</span><strong>설계자</strong>
        ...
        <div class="score"> 
            <strong class="percent">예매율&nbsp;<span>6.9%</span></strong>
        ...
        <div class="spec">
            <dl>
                ...
                <dd>
                        ...
                        <a href="/movies/persons/?pidx=124244">이요섭</a>                    
                ...
                <dd class="on">
                        ...
                        <a href="/movies/persons/?pidx=33445">강동원</a>                    
                        
                        ,&nbsp;
                        <a href="/movies/persons/?pidx=123816">이무생</a>                    
                        
                        ,&nbsp;
                        <a href="/movies/persons/?pidx=17244">이미숙</a>                    
                        
                        ,&nbsp;
                        <a href="/movies/persons/?pidx=124563">이현우</a>                    
                        
                        ,&nbsp;
                        <a href="/movies/persons/?pidx=30693">탕준상</a>    
                        
                        ,&nbsp;
                        <a href="/movies/persons/?pidx=30693">김홍파</a> 
                        
                        ,&nbsp;
                        <a href="/movies/persons/?pidx=30693">김신록</a> 
                        
                        ,&nbsp;
                        <a href="/movies/persons/?pidx=30693">이동휘</a>                 
                ...
                <dd class="on">15세이상관람가,&nbsp;99분,&nbsp;한국</dd>
                <dt>개봉 :&nbsp;</dt>
    ...
    <div class="cols-content" id="menu">
        <div class="col-detail">
            ...
            <div class="sect-story-movie">
                <strong>“정말 우연이라고 생각해요?”</strong><br><br>
                
				의뢰받은 청부 살인을 사고사로 조작하는 설계자 ‘영일’(강동원)<br>
				그의 설계를 통해 우연한 사고로 조작된 죽음들이<br>
				실은 철저하게 계획된 살인이라는 것을 아무도 알지 못한다.<br><br>
				
				최근의 타겟 역시 아무 증거 없이 완벽하게 처리한 ‘영일’에게<br>
				새로운 의뢰가 들어온다.<br>
				이번 타겟은 모든 언론과 세상이 주목하고 있는 유력 인사.<br>
				작은 틈이라도 생기면 자신의 정체가 발각될 수 있는 위험한 의뢰지만<br>
				‘영일’은 그의 팀원인 ‘재키’(이미숙),<br>
				‘월천’(이현욱), ‘점만’(탕준상)과 함께 이를 맡기로 결심한다.<br>
				철저한 설계와 사전 준비를 거쳐 마침내 실행에 옮기는 순간<br>
				‘영일’의 계획에 예기치 못한 변수가 발생하는데...!<br><br>

				<strong>사고인가<br>
				
				살인인가<br>
				
				그의 실체가 드러나기 시작했다!</strong>
			</div>
