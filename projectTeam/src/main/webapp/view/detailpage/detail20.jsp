...
<div class="sect-base-movie">
    <h3><strong>내 손끝에 너의 온도가 닿을 때</strong>기본정보</h3>
    <div class="box-image">
        <a href="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88234/88234_320.jpg" title="포스터 크게 보기 새창" target="_blank">
            <span class="thumb-image"> 
                <img src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88234/88234_320.jpg" alt="인사이드 아웃 2 포스터 새창" onerror="errorImage(this)">
    ...
    <div class="box-contents">
        <div class="title"> 
            <span class="age-15">15</span><strong>내 손끝에 너의 온도가 닿을 때</strong>
        ...
        <div class="spec">
            <dl>
                ...
                <dd class="on">15세이상관람가,&nbsp;101분,&nbsp;한국</dd>
                <dt>개봉 :&nbsp;</dt>
    ...
    <div class="cols-content" id="menu">
        <div class="col-detail">
            ...
            <div class="sect-story-movie">
				...
				어려서부터 형제처럼 자라온 호태와 동희. 몇 년 전, 서울로 이사를 간 호태는 아버지가 돌아가신 뒤 엄마와 함께 강릉으로 돌아온다. <br>
				오랜만에 재회한 두 사람은 한 지붕 아래에서 함께 지내게 된다. <br>
				동희는 친형제 같은 존재지만 동시에 자신의 첫사랑이기도 한 호태를 보며 다시 설레고, 그 마음을 억누르려 하지만 쉽지 않다. <br>
				호태도 오랜만에 만난 동희에게 지금까지 경험해 보지 못했던 감정을 느끼게 된다. 두 사람의 아슬아슬한 관계는 예상치 못한 사건을 계기로 점점 변하기 시작하는데...<br>
