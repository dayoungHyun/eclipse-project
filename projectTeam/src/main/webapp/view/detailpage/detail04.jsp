...
<div class="sect-base-movie">
    <h3><strong>명탐정 코난 VS 괴도 키드</strong>기본정보</h3>
    <div class="box-image">
        <a href="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88272/88272_320.jpg" title="포스터 크게 보기 새창" target="_blank">
            <span class="thumb-image"> 
                <img src="https://img.cgv.co.kr/Movie/Thumbnail/Poster/000088/88272/88272_320.jpg" alt="인사이드 아웃 2 포스터 새창" onerror="errorImage(this)">
    ...
    <div class="box-contents">
        <div class="title"> 
            <span class="age-12">12</span><strong>명탐정 코난 VS 괴도 키드</strong>
        ...
        <div class="spec">
            <dl>
                ...
                <dd>
                        ...
                        <a href="/movies/persons/?pidx=124244">이시하라 슌스케</a>                    
                ...
                <dd class="on">12세이상관람가,&nbsp;81분,&nbsp;일본</dd>
                <dt>개봉 :&nbsp;</dt>
    ...
    <div class="cols-content" id="menu">
        <div class="col-detail">
            ...
            <div class="sect-story-movie">
                <strong>“괴도 1412호, 이름하여 괴도 KID”</strong><br><br>

				암호가 섞인 예고장이 보내진 그곳에는<br>
				월하의 마술사, 괴도 키드가 나타난다.<br>
				세상을 떠들썩하게 만들며 인기를 얻고 있는 그의 정체는<br>
				에코다 고등학교 2학년 쿠로바 카이토.<br>
				수수께끼의 조직에 살해당한 세계적인 마술사였던<br>
				아버지 쿠로바 도이치의 뒤를 이어<br>
				사건의 진상을 파헤치기 위해 2대 ‘괴도 키드’가 되어<br>
				도이치가 쫓던 ‘빅 주얼’과 조직의 정체를 향해 다가간다.<br><br>
				
				이번에 그가 노리는 ‘빅 주얼’은 ‘대해의 기적’이자<br>
				‘블루 원더’라고 불리는 전설의 아쿠아마린.<br>
				소노코의 친척이자 키드 체포에 열을 올리고 있는<br>
				스즈키 지로키치가 그에게 먼저 도전장을 내밀고,<br>
				언제나 그랬듯 괴도 키드는 모두의 예상을 뒤엎고<br>
				신출귀몰한 방법으로 나타나는데…<br>
				이를 막기 위해 불가능을 모르는 명탐정, 코난의 명추리가 펼쳐진다!<br><br>
				
				<strong>사상 최대의 라이벌 탄생!<br>
				화려한 괴도와 그를 쫓는 명탐정<br>
				모든 것의 시작은 여기서부터!<br>
				월하의 마술사 괴도 키드의 탄생과 영원한 최대의 라이벌,<br>
				코난-쿠도 신이치와의 첫 대결이 시작된다!</strong>
			</div>
